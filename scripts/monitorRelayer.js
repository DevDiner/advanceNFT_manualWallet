...
async function main() {
    ...
    if (!relayerPrivateKey) {
        ...
        console.error("   Please set it to the private key of the wallet you want to monitor.");
        process.exit(1);
    }
    ...
    console.log(`- Monitoring Network: ${network.name} (Chain ID: ${network.chainId})`);
    ...
    try {
        ...
        if (balanceWei < threshold) {
            ...
            console.log("==========================================================");
            console.log(`  Current balance (${balanceEth} ETH) is below the threshold of ${THRESHOLD_ETH} ETH.`);
            console.log(`  Please fund the relayer wallet at: ${relayerWallet.address}`);
            console.log("  Meta-transactions may fail if the wallet runs out of gas.");
            console.log("==========================================================");
        } else {
