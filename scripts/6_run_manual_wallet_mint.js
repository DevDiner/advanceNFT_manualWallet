...
// 4. Manually ABI-encode the `revealPublic` function call.
...
async function main() {
  ...
  console.log(`\nManually encoding 'revealPublic' call...`);
  const revealCalldata = nft.interface.encodeFunctionData("revealPublic", [
    secret,
  ]);
